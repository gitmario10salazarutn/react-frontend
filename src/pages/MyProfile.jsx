...
function MyProfile(props) {
    ...
    const url = "https://mario10salazar-apputn.onrender.com/";
    ...
    const handleSubmitSaveLanguage = (e) => {
        ...
        const valuesarray = ["language description", "knowledge level", "language programming", "user"];
    ...
    const openEditUser = (user) => {
        editData(user);
        ToastCustom("warning", "User " + user.email + " found to edit!", "Successful!");
    ...
    const openEditLanguage = async (id) => {
        getLanguageById(id).then((resp) => {
            ...
            ToastCustom(
                "warning",
                "Language " + resp.data.token.language_programming.language_name + " found to edit!",
                "Successful!"
            );
        });
    ...
    const handleSubmitEditLanguage = (e) => {
        ...
        if (validate.length === 0) {
            axios
                .post(url + "users/update_languagelearn/" + languageLearned.id_langlearn, data)
                .then((res) => {
                    let response = res.data;
                    if (response.token != null) {
                        Users.user = response.token.user;
    ...
    const confirmDeleteLanguageDialog = (id) => {
        getLanguageById(id).then((resp) => {
            ...
            ToastCustom(
                "warning",
                "Language " + resp.data.token.language_programming.language_name + " found to remove!",
                "Successful!"
            );
        });
    ...
    const confirmDeleteUser = (user) => {
        ToastCustom("warning", "User " + user.email + " found to remove!", "Successful!");
    ...
    const deleteUser = (e) => {
        ...
        if (validate.length === 0) {
            axios
                .delete(url + "users/delete_user/" + user.user_name, {
                    data: { password: password },
                })
                .then((res) => {
                    let response = res.data;
                    if (response.token === 1) {
                        ...
                        <NavBar user={null} />;
                        ToastCustom("success", "User Deleted: " + user.email, "Successful!");
                    } else {
    ...
    const confirmChangePassword = (user) => {
        ToastCustom("warning", "User " + user.email + " found to change password!", "Successful!");
        setChangePasswordDialog(true);
    };

    const changePasswordUser = (e) => {
        e.preventDefault();
        const inputarray = [data.lastpassword, data.new_password, data.rep_password];
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (response.token === 1) {
                        setChangePasswordDialog(false);
                        clearData();
                        ToastCustom("success", res.data.message + " to user: " + user.email, "Successful!");
                    } else {
            ...
            <div className="home" id="form1">
                <div className="profile-container">
                            ...
                            <div className="detail-main">
                                ...
                                <div className="detail">
                                    ...
                                    <div className="detail-left">
                                        ...
                                        <h3>
                                            <MDBBadge color={user.user_state ? "success" : "danger"} pill>
                    ...
                    <div className="box-profile">
                        ...
                        <div className={language === null ? "scroll-b" : "scroll-a"} key={user.id_user}>
                            {language === null ? (
                                <>
                                                        ...
                                                        <i
                                                            className={
                                                                t === 1
                                                                    ...
                                                                    : t === 3 &&
                                                                      "fa-solid fa-palette detail-icon"
                                                            }
                                                        ></i>
                                                        <p>
                                                            {
                                                    ...
                                                    <div className="language-descr">
                                                        <div className="descr-title">
                                                            <div className="lang-title">
                                                                <p>
                                                                    {lang.language_programming.language_name}
                                                                </p>
                                                            </div>
                                ...
                                <Grid container spacing={3}>
                                    <Grid item xs={12} sm={6}>
                                        <span className="p-float-label">
                                            ...
                                            />
                                            <label className="input-label" htmlFor="language_programming">
                ...
                >
                    <div className="confirmation-content">
                        <i className="pi pi-exclamation-triangle mr-2 warn" style={{ fontSize: "4rem" }} />
                        {languageLearned && (
                            <div className="question" style={{ fontSize: "1.1rem" }}>
