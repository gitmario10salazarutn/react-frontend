...
function NavBar(props) {
    ...
    function open(name) {
        if (name === "open_home") {
            ...
            setInitPage(false);
            setSkills(false);
            ToastCustom("info", "I'm sorry, This page is on building proccess!!", "Message info!");
        }
    ...
    return (
        <div>
            <nav className="NavBarItems">
                ...
                >
                    <h4 className="logo">
                        {login ? user.person.first_name + " " + user.person.last_name : "Main Page"}
                    ...
                    {Menu.map((item) => {
                        return (
                            <li
                                key={item.id}
                                className="item-nav"
                                style={{ display: item.security_level.public ? "" : !login && "none" }}
                            >
                                <NavLink
                                    to=""
                                    onClick={() => {
            ...
            <ToastContainer />
            {log & login ? <MyProfile user={user} login={log} /> : !login & log ? <Login /> : null}
            {home && <Home user={user} />}
