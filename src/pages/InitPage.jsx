                ...
                <div className="initpage-main">
                    <div className="initpage-right">
                        <div className="initpage-title">
                            <p>Hi, I'm {user.person.first_name + " " + user.person.last_name}</p>
                        </div>
                        ...
                        <div className="initpage-phrase">
                            ...
                            <p>
                                ...
                                expedita deleniti voluptate. Enim quia officia quod quisquam est, perspiciatis
                                eaque sint magni repellendus eos, vero, quasi nulla et. Recusandae, distinctio
                                sapiente dolorum quaerat quae atque nemo dolor cum! Natus, nemo voluptatibus
                                similique obcaecati repellendus alias fugit impedit recusandae corporis
                                aliquam totam minima perferendis nulla voluptatum sequi. Repudiandae, porro.
                            </p>
                        </div>
