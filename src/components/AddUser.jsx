...
const UsersPage = () => {
    ...
    const handleSubmitSaveUser = (e) => {
        ...
        if (validate.length === 0) {
            if (data.password === data.rep_password) {
                axios
                    .post("https://app-cent-mariosalazar.herokuapp.com/users/create_user", data)
                    .then((res) => {
    ...
    const deleteUser = (e) => {
        e.preventDefault();
        axios
            .delete("https://app-cent-mariosalazar.herokuapp.com/users/delete_user/" + user.user.user_name)
            .then((res) => {
                let response = res.data;
                if (response.token === 1) {
    ...
    const setEnableUser = (e) => {
        e.preventDefault();
        axios
            .post("https://app-cent-mariosalazar.herokuapp.com/users/setenable_user/" + user.user.user_name)
            .then((res) => {
                let response = res.data;
                if (response.token === 1) {
                    ...
                    <div className="column-actions">
                        <React.Fragment>
                            ...
                            <IconButton
                                ...
                                title={!rowData.user.user_state ? "Enable user" : "Disable user"}
                                component="label"
                                onClick={() => confirmsetEnableUser(rowData.user.user_name)}
                            >
                                <Icon>{rowData.user.user_state ? "cancel_rounded" : "check_circle"}</Icon>
                            </IconButton>
                            <IconButton
                                color="info"
                                component="label"
        ...
        <div className="datatable-crud-demo">
            ...
            <div className="card">
                ...
                >
                    ...
                    <Column field="user.register_date" header="Date Register" sortable></Column>
            ...
            >
                <div className="confirmation-content">
                    <i className="pi pi-exclamation-triangle mr-2 warn" style={{ fontSize: "6rem" }} />
                    {user && (
